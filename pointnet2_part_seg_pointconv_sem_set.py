...
class get_model(nn.Module):
    def __init__(self, num_classes):
        ...
        feature_dim = 3
        self.sa1 = PointConvSetAbstraction(npoint=512, nsample=32, in_channel=feature_dim + 3, mlp=[32, 32, 64],  group_all=False)
        self.sa2 = PointConvSetAbstraction(npoint=256, nsample=32, in_channel=64 + 3, mlp=[64, 64, 128], group_all=False)
        self.sa3 = PointConvSetAbstraction(npoint=64, nsample=32, in_channel=128 + 3, mlp=[128, 128, 256],  group_all=False)
        self.sa4 = PointConvSetAbstraction(npoint=16, nsample=32, in_channel=256 + 3, mlp=[256, 256, 512],  group_all=False)
